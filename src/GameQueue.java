...
public class GameQueue {
    Queue<Integer> firstPlayer, secondPlayer; // FIFO

    public GameQueue(String firstPlayer, String secondPlayer) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new GameQueue("19046", "57823").play());
        System.out.println(new GameQueue("04876", "93215").play());
    }
